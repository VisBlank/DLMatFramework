...
class ThreeLayerConvNet(object):
  ...
  def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
    ...
    C, H, W = input_dim
    # Initialize weights, also taking care to do symetry breaking.
  ...
  def loss(self, X, y=None):
    ...
    # variable.                                                                #
    ############################################################################
    # First layer (CONV-RELU sandwich)
    ...
    # Backprop on layer 2 (Maxpooling)
    # Observe that maxpooling has no parameters...
    pool_dx = max_pool_backward_fast(affine1_dx, pool_cache)

    # Backprop on layer 1 (CONV-RELU sandwich)
    ...
    #                             END OF YOUR CODE                             #
    ############################################################################
    # Return loss and the gradients of the loss w.r.t to it's parameters
    return loss, grads
